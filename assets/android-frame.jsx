...
function AndroidDevice({
  ...
  // Background shown behind status bar + gesture nav bar.
  // Pass the screen's canvas color so the system chrome blends in.
  background,
}) {
  const bg = background ?? (dark ? '#1d1b20' : MD_C.surface);
  return (
    <div style={{
