...
const BR_T_SOURCE = {
  en: {
    ...
    pub: { title: "Publishing", queued: "Queued", posted: "Posted", retry: "Retrying", failed: "Failed", notStarted: "Not sent", staggered: "staggered to avoid rate limit", retryNote: "Auto-retry · exponential backoff", monitor: "Monitoring first 2 hours" },
  ...
  id: {
    ...
    pub: { title: "Mengirim", queued: "Antre", posted: "Terkirim", retry: "Coba ulang", failed: "Gagal", notStarted: "Belum dikirim", staggered: "dijeda agar tak kena rate limit", retryNote: "Auto-retry · exponential backoff", monitor: "Pantau 2 jam pertama" },
